package id.ac.poliban.mi.yusfan.proyek1;
...
public class InsertAndViewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        if(!tempCatatan.equals(edContent.getText().toString())){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edFileName = findViewById(R.id.editFilename);
    ...
    void bacaFile() {
        ...
        File file = new File(path, edFileName.getText().toString());
        if (file.exists()){
            ...
            edContent.setText(text.toString());
        }
    }
    ...
    void buatDanUbah(){
        ...
        if (parent.exists()){
            ...
            try{
                ...
                streamWriter.append(edContent.getText());
                streamWriter.flush();
                streamWriter.close();
                outputStream.flush();
                outputStream.close();
            ...
            try{
                ...
                outputStream.write(edContent.getText().toString().getBytes());
                outputStream.flush();
                outputStream.close();
            } catch (Exception e){
                e.printStackTrace();
    ...
    void tampilkanDialogKonfirmasiPenyimpanan() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Aapakah Anda yakin ingin menyimpan Catatan ini?")
