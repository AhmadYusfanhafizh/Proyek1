...
public class MainActivity extends AppCompatActivity {
    ...
    final void tampilkanDialogKonfirmasiHapusCatatan(String filename) {
        new AlertDialog.Builder(this)
                .setTitle("Hapus Catatan ini")
                .setMessage("Apakah anda yakin ingin mengapus Catatan" + filename + "?")
    ...
    private void mengambilListFilePadaFolder() {
        ...
        if (directory.exists()){
            ...
            for(int i = 0; i <files.length; i++){
                ...
                dateCreates[i] = simpleDateFormat.format(lastModDate);
